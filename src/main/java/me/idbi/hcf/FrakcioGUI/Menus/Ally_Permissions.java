...
public class Ally_Permissions {
    ...
    public static Inventory inv(AllyFaction ally) {
        Inventory inv = Bukkit.createInventory(null, 5*9, ally.getAllyFaction().name + " Ally Permissions");
        ...
        inv.setItem(15, Ally_Items.permission_viewItems());
        ...
        inv.setItem(44, RP_Items.save());
        inv.setItem(36, RP_Items.cancel());
